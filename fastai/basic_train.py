...
class Recorder(LearnerCallback):
    ...
    def plot_lr(self, show_moms=False, skip_start:int=0, skip_end:int=0, return_fig:bool=None)->Optional[Any]:
    ...
    def plot_losses(self, skip_start:int=0, skip_end:int=0, return_fig:bool=None)->Optional[Any]:
    ...
    def plot_metrics(self, skip_start:int=0, skip_end:int=0, return_fig:bool=None)->Optional[Any]:
