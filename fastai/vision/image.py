...
def _draw_rect(ax, b:Collection[int], color:str='white', text=None, text_size=14):
...
class Image(ItemBase):
    ...
    def show(self, ax=None, figsize:tuple=(3,3), title:Optional[str]=None, hide_axis:bool=True,
...
class ImagePoints(Image):
    ...
    def show(self, ax=None, figsize:tuple=(3,3), title:Optional[str]=None, hide_axis:bool=True, **kwargs):
...
class ImageBBox(ImagePoints):
    ...
    def show(self, y:Image=None, ax=None, figsize:tuple=(3,3), title:Optional[str]=None, hide_axis:bool=True,
...
def show_image(img:Image, ax=None, figsize:tuple=(3,3), hide_axis:bool=True, cmap:str='binary',
...
def plot_multi(func:Callable[[int,int,int],None], r:int=1, c:int=1, figsize:Tuple=(12,6)):
